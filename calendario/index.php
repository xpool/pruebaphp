...
<head>
        ...
        <meta http-equiv="EXPIRES" content="-1" />      <!-- esto es HTML, se edita así! ¬¬ -->
...
<body>
        ...
        <?php
                        ...
                        echo "<h2>Calendario de Eventos para: <i>".$meses[$mesactual]." de ".$elanio."</i></h2>";
                        echo $mostrar;
